...
var vec__37552_37555 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_37556 = cljs.core.nth.call(null,vec__37552_37555,(0),null);
var only_after_37557 = cljs.core.nth.call(null,vec__37552_37555,(1),null);
var db_changed_QMARK__37558 = (!((only_before_37556 == null))) || (!((only_after_37557 == null)));
if(db_changed_QMARK__37558){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_37556);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_37557);
...
var map__37559 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var map__37562 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__37562__$1;
var event = cljs.core.get.call(null,map__37562__$1,new cljs.core.Keyword(null,"event","event",301435442));
var new_context = cljs.core.assoc.call(null,context,new cljs.core.Keyword(null,"effects","effects",-282369292),handler_fn.call(null,coeffects,event));
if(re_frame.trace.is_trace_enabled_QMARK_.call(null)){
var new_trace__37292__auto___37564 = cljs.core.merge.call(null,cljs.core.update.call(null,re_frame.trace._STAR_current_trace_STAR_,new cljs.core.Keyword(null,"tags","tags",1771418977),cljs.core.merge,new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tags","tags",1771418977),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"effects","effects",-282369292),new cljs.core.Keyword(null,"effects","effects",-282369292).cljs$core$IFn$_invoke$arity$1(new_context),new cljs.core.Keyword(null,"coeffects","coeffects",497912985),new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context)], null)], null))),cljs.core.dissoc.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tags","tags",1771418977),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"effects","effects",-282369292),new cljs.core.Keyword(null,"effects","effects",-282369292).cljs$core$IFn$_invoke$arity$1(new_context),new cljs.core.Keyword(null,"coeffects","coeffects",497912985),new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context)], null)], null),new cljs.core.Keyword(null,"tags","tags",1771418977)));
re_frame.trace._STAR_current_trace_STAR_ = new_trace__37292__auto___37564;
...
var new_context = handler_fn.call(null,context);
if(re_frame.trace.is_trace_enabled_QMARK_.call(null)){
var new_trace__37292__auto___37565 = cljs.core.merge.call(null,cljs.core.update.call(null,re_frame.trace._STAR_current_trace_STAR_,new cljs.core.Keyword(null,"tags","tags",1771418977),cljs.core.merge,new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tags","tags",1771418977),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"effects","effects",-282369292),new cljs.core.Keyword(null,"effects","effects",-282369292).cljs$core$IFn$_invoke$arity$1(new_context),new cljs.core.Keyword(null,"coeffects","coeffects",497912985),new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context)], null)], null))),cljs.core.dissoc.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tags","tags",1771418977),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"effects","effects",-282369292),new cljs.core.Keyword(null,"effects","effects",-282369292).cljs$core$IFn$_invoke$arity$1(new_context),new cljs.core.Keyword(null,"coeffects","coeffects",497912985),new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context)], null)], null),new cljs.core.Keyword(null,"tags","tags",1771418977)));
re_frame.trace._STAR_current_trace_STAR_ = new_trace__37292__auto___37565;
...
var len__29455__auto___37567 = arguments.length;
var i__29456__auto___37568 = (0);
while(true){
if((i__29456__auto___37568 < len__29455__auto___37567)){
args__29462__auto__.push((arguments[i__29456__auto___37568]));

var G__37569 = (i__29456__auto___37568 + (1));
i__29456__auto___37568 = G__37569;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq37566){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37566));
});
...
var args__29462__auto__ = [];
var len__29455__auto___37575 = arguments.length;
var i__29456__auto___37576 = (0);
while(true){
if((i__29456__auto___37576 < len__29455__auto___37575)){
args__29462__auto__.push((arguments[i__29456__auto___37576]));

var G__37577 = (i__29456__auto___37576 + (1));
i__29456__auto___37576 = G__37577;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__37570_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__37571_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__37571_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq37572){
var G__37573 = cljs.core.first.call(null,seq37572);
var seq37572__$1 = cljs.core.next.call(null,seq37572);
var G__37574 = cljs.core.first.call(null,seq37572__$1);
var seq37572__$2 = cljs.core.next.call(null,seq37572__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__37573,G__37574,seq37572__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1518448601498
