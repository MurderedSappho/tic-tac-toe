...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__37134 = cljs.core.instance_QMARK_;
var expr__37135 = reactive_val;
if(cljs.core.truth_(pred__37134.call(null,reagent.ratom.RAtom,expr__37135))){
return "ra";
} else {
if(cljs.core.truth_(pred__37134.call(null,reagent.ratom.RCursor,expr__37135))){
return "rc";
} else {
if(cljs.core.truth_(pred__37134.call(null,reagent.ratom.Reaction,expr__37135))){
return "rx";
} else {
if(cljs.core.truth_(pred__37134.call(null,reagent.ratom.Track,expr__37135))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1518448600525
