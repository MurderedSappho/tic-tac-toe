...
var o38642 = temp__4655__auto__;
var temp__4655__auto____$1 = (o38642["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38643 = temp__4655__auto____$1;
return (o38643["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__37755__auto__ = f;
return (o__37755__auto__["toString"]).call(o__37755__auto__);
} else {
return "";
}
}catch (e38644){var _ = e38644;
return "";
}});
...
try{var o__37755__auto___38646 = t;
(o__37755__auto___38646["cljs$lang$ctorPrWriter"]).call(o__37755__auto___38646,t,writer);
}catch (e38645){var __38647 = e38645;
}
...
var char_code = (function (){var o__37755__auto__ = (new String(char$));
return (o__37755__auto__["charCodeAt"]).call(o__37755__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__37755__auto__ = String;
return (o__37755__auto__["fromCharCode"]).call(o__37755__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38648 = num_code;
switch (G__38648) {
case (1):
return (185);
...
var o__37755__auto__ = String;
return (o__37755__auto__["fromCharCode"]).call(o__37755__auto__,superscript_code);
});
/**
...
}catch (e38650){var _e__37762__auto__ = e38650;
return false;
}})())){
...
var vec__38651 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__38651,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o38654 = temp__4655__auto__;
var temp__4655__auto____$1 = (o38654["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38655 = temp__4655__auto____$1;
return (o38655["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29455__auto___38662 = arguments.length;
var i__29456__auto___38663 = (0);
while(true){
if((i__29456__auto___38663 < len__29455__auto___38662)){
args__29462__auto__.push((arguments[i__29456__auto___38663]));

var G__38664 = (i__29456__auto___38663 + (1));
i__29456__auto___38663 = G__38664;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38658){
var vec__38659 = p__38658;
var ns_detector = cljs.core.nth.call(null,vec__38659,(0),null);
...
var G__38665 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__38666 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__38665;
remaining_tokens = G__38666;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38656){
var G__38657 = cljs.core.first.call(null,seq38656);
var seq38656__$1 = cljs.core.next.call(null,seq38656);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__38657,seq38656__$1);
});
...
var vec__38670 = cljs.core.split_with.call(null,(function (p1__38669_SHARP_){
return cljs.core.not_EQ_.call(null,p1__38669_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__38670,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__38670,(1),null);
...
var vec__38673 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__38673,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__38673,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__38676 = cljs.core.rest.call(null,remaining_tokens);
var G__38677 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__38676;
name_tokens = G__38677;
continue;
} else {
...
var vec__38680 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__38680,(0),null);
var arity = cljs.core.nth.call(null,vec__38680,(1),null);
var vec__38683 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__38683,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__38683,(1),null);
var vec__38686 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__38686,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__38686,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__38686,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__38686,(3),null);
...
var vec__38692 = result;
var munged_ns = cljs.core.nth.call(null,vec__38692,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__38692,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__38692,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__38692,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__38692,(4),null);
var arity = cljs.core.nth.call(null,vec__38692,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__38696 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__38696,(0),null);
var args = cljs.core.nth.call(null,vec__38696,(1),null);
var vec__38699 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__38699,(0),null);
var name = cljs.core.nth.call(null,vec__38699,(1),null);
...
var G__38702 = (arity + (1));
var G__38703 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38704){
var vec__38705 = p__38704;
var arity = cljs.core.nth.call(null,vec__38705,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__38705,(1),null);
...
return cljs.core.get.call(null,arities,p1__38708_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__38709_SHARP_);
...
var args__29462__auto__ = [];
var len__29455__auto___38716 = arguments.length;
var i__29456__auto___38717 = (0);
while(true){
if((i__29456__auto___38717 < len__29455__auto___38716)){
args__29462__auto__.push((arguments[i__29456__auto___38717]));

var G__38718 = (i__29456__auto___38717 + (1));
i__29456__auto___38717 = G__38718;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38712){
var vec__38713 = p__38712;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__38713,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38710){
var G__38711 = cljs.core.first.call(null,seq38710);
var seq38710__$1 = cljs.core.next.call(null,seq38710);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__38711,seq38710__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__38721__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__38721__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__38721__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__38721__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38722 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__38722,(0),null);
var fn_name = cljs.core.nth.call(null,vec__38722,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__38722,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__38722,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__38722,(4),null);
var arity = cljs.core.nth.call(null,vec__38722,(5),null);
...
var o__37755__auto__ = f;
return (o__37755__auto__["getBasis"]).call(o__37755__auto__);
});
/**
...
}catch (e38726){var _e__37762__auto__ = e38726;
...
var G__38727 = (obj[cljs.core.first.call(null,path)]);
var G__38728 = cljs.core.rest.call(null,path);
obj = G__38727;
path = G__38728;
continue;
} else {
...
return (function (accum,p__38729){
var vec__38730 = p__38729;
var bit = cljs.core.nth.call(null,vec__38730,(0),null);
var protocol = cljs.core.nth.call(null,vec__38730,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__38733){
var vec__38734 = p__38733;
var ns = cljs.core.nth.call(null,vec__38734,(0),null);
var name = cljs.core.nth.call(null,vec__38734,(1),null);
var selector = cljs.core.nth.call(null,vec__38734,(2),null);
...
return (function (p__38738){
var vec__38739 = p__38738;
var munged_name = cljs.core.nth.call(null,vec__38739,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__38739,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__38739,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__38737_SHARP_){
return (obj[cljs.core.first.call(null,p1__38737_SHARP_)]);
});})(name,sorted_matches,vec__38739,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1518448603239
