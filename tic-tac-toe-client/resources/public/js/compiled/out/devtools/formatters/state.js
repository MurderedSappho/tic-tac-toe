...
var len__29455__auto___38764 = arguments.length;
var i__29456__auto___38765 = (0);
while(true){
if((i__29456__auto___38765 < len__29455__auto___38764)){
args__29462__auto__.push((arguments[i__29456__auto___38765]));

var G__38766 = (i__29456__auto___38765 + (1));
i__29456__auto___38765 = G__38766;
continue;
} else {
}
break;
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq38762){
var G__38763 = cljs.core.first.call(null,seq38762);
var seq38762__$1 = cljs.core.next.call(null,seq38762);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__38763,seq38762__$1);
});
...
return (p1__38767_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1518448603419
