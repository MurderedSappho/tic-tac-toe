...
var G__38744 = devtools.prefs.pref.call(null,v);
v = G__38744;
continue;
} else {
return v;
...
}catch (e38747){var _e__37762__auto__ = e38747;
return false;
}})();
...
}catch (e38751){var _e__37762__auto__ = e38751;
return false;
}})();
...
}catch (e38753){var _e__37762__auto__ = e38753;
return false;
}}
}
});
...
var vec__38755 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__38755,(0),null);
var name = cljs.core.nth.call(null,vec__38755,(1),null);
...
return cljs.core.some.call(null,(function (p1__38758_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__38758_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1518448603361
