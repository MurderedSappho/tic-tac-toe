...
return (new CustomEvent(event_name,(function (){var obj34392 = {"detail":data};
return obj34392;
})()));
} else {
...
var f = (function (){var pred__34399 = cljs.core._EQ_;
var expr__34400 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34399.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34400))){
return ((function (pred__34399,expr__34400){
return (function (p1__34393_SHARP_){
return console.warn(p1__34393_SHARP_);
});
;})(pred__34399,expr__34400))
} else {
if(cljs.core.truth_(pred__34399.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34400))){
return ((function (pred__34399,expr__34400){
return (function (p1__34394_SHARP_){
return console.debug(p1__34394_SHARP_);
});
;})(pred__34399,expr__34400))
} else {
if(cljs.core.truth_(pred__34399.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34400))){
return ((function (pred__34399,expr__34400){
return (function (p1__34395_SHARP_){
return console.error(p1__34395_SHARP_);
});
;})(pred__34399,expr__34400))
} else {
return ((function (pred__34399,expr__34400){
return (function (p1__34396_SHARP_){
return console.log(p1__34396_SHARP_);
});
;})(pred__34399,expr__34400))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34403){
...
var opts = map__34404__$1;
var eval_fn = cljs.core.get.call(null,map__34404__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34406_SHARP_);
});})(new_def))
);
...
return (function (p__34407){
var vec__34408 = p__34407;
var ky = cljs.core.nth.call(null,vec__34408,(0),null);
var v = cljs.core.nth.call(null,vec__34408,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1518448596242
