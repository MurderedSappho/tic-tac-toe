...
var G__36986 = o;
(G__36986[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__36987__delegate = function (args){
...
while (G__36988__i < G__36988__a.length) {G__36988__a[G__36988__i] = arguments[G__36988__i + 0]; ++G__36988__i;}
  args = new cljs.core.IndexedSeq(G__36988__a,0,null);
} 
return G__36987__delegate.call(this,args);};
G__36987.cljs$lang$maxFixedArity = 0;
G__36987.cljs$lang$applyTo = (function (arglist__36989){
var args = cljs.core.seq(arglist__36989);
return G__36987__delegate(args);
});
...
var G__36992 = jsprops;
(G__36992["defaultValue"] = value);

(G__36992["onChange"] = ((function (G__36992,v,value,on_change){
return (function (p1__36991_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__36991_SHARP_);
});})(G__36992,v,value,on_change))
);
...
var vec__36995 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__36995,(0),null);
var id = cljs.core.nth.call(null,vec__36995,(1),null);
var class$ = cljs.core.nth.call(null,vec__36995,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___36999 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___36999 == null)){
} else {
var key_37000 = temp__4661__auto___36999;
(jsprops["key"] = key_37000);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__37001 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__37001["name"] = c);
...
var len__29455__auto___37006 = arguments.length;
var i__29456__auto___37007 = (0);
while(true){
if((i__29456__auto___37007 < len__29455__auto___37006)){
args__29462__auto__.push((arguments[i__29456__auto___37007]));

var G__37008 = (i__29456__auto___37007 + (1));
i__29456__auto___37007 = G__37008;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37004){
var G__37005 = cljs.core.first.call(null,seq37004);
var seq37004__$1 = cljs.core.next.call(null,seq37004);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__37005,seq37004__$1);
});
...
break;
default:
var G__37011 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__37011;
continue;
...
var n__29231__auto___37013 = a.length;
var i_37014 = (0);
while(true){
if((i_37014 < n__29231__auto___37013)){
(a[i_37014] = reagent.impl.template.as_element.call(null,(a[i_37014])));

var G__37015 = (i_37014 + (1));
i_37014 = G__37015;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__29231__auto___37016 = a.length;
var i_37017 = (0);
while(true){
if((i_37017 < n__29231__auto___37016)){
var val_37018 = (a[i_37017]);
if((cljs.core.vector_QMARK_.call(null,val_37018)) && ((reagent.impl.template.key_from_vec.call(null,val_37018) == null))){
(o["no-key"] = true);
} else {
}

(a[i_37017] = reagent.impl.template.as_element.call(null,val_37018));

var G__37019 = (i_37017 + (1));
i_37017 = G__37019;
continue;
} else {
}
...
var ctx = ({});
var vec__37020 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__37020,(0),null);
var derefed = cljs.core.nth.call(null,vec__37020,(1),null);
...
var G__37023 = (cljs.core.count.call(null,argv) - first_child);
switch (G__37023) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__37023){
...
//# sourceMappingURL=template.js.map?rel=1518448600176
